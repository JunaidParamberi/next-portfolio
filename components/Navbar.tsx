...
const Navbar = () => {
  ...
  return (
    <div
      className={`w-full fixed top-0 flex justify-center items-center py-5 navbar transition-transform duration-300  ${
        showNavbar ? "translate-y-0" : "-translate-y-full"
      }`}
    >
      <nav className="w-[80%] flex justify-between items-center">
        <Link href="/">
          <Image className="w-[10vw]" src={whiteLogo} alt="white logo" />
        </Link>
